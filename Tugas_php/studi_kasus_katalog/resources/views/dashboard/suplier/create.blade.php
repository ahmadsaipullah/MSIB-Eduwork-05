...
@section('title', 'Create Suplier')
@section('content')
    <div class="col-md-12 col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title text-center">Create Suplier</h4>
            </div>
            <div class="card-content">
                <div class="card-body">
                    <form class="form form-horizontal" method="POST" action="{{ route('supliers.store') }}">
                        @csrf
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-8 form-group">
                                    ...
                                    @enderror"
                                        value="{{ old('perusahaan') }}" placeholder="Perusahaan">
                                    @error('perusahaan')
                                ...
                                <div class="col-md-8 form-group">
                                    ...
                                    @enderror"
                                        value="{{ old('telp') }}" placeholder="Telepon">
                                    @error('telp')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-8 form-group">
                                    ...
                                    @enderror"
                                        value="{{ old('negara') }}" placeholder="Negara">
                                    @error('negara')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
