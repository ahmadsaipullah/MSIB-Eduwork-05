...
<body>
  ...
  <div class="container section-navbar">
    ...
    <div class="row d-flex justify-content-center">
      <div class="col-md-8">
        <form action="edit.php?id_penerbit=<?php echo $id_penerbit; ?>" method="post" class="border py-4 px-4">
          <div class="row mb-3">
            <label for="id_penerbit" class="col-sm-2 col-form-label">Id Penerbit</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" id="id_penerbit" name="id_penerbit" value="<?php echo $id_penerbit; ?>" readonly>
            </div>
          </div>
          <div class="row mb-3">
